...
class CanalTestCase(TestCase):
    def setUp(self):
        self.usuario_a = User.objects.create(username='usuario1', password='123')
        self.usuario_b = User.objects.create(username='usuario2', password='456')
        self.usuario_c = User.objects.create(username='usuario3', password='789')
